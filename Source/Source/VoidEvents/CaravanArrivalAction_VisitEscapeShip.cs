...
namespace VoidEvents
{
	public class CaravanArrivalAction_VisitEscapeShip : CaravanArrivalAction
	{
		...
		public CaravanArrivalAction_VisitEscapeShip(VoidEscapeShipComp escapeShip)
		{
		...
		{
			if (escapeShip == null || !escapeShip.Spawned || escapeShip.GetComponent<VoidEscapeShipComp>() == null)
			{
				return false;
			}
		...
		{
			return CaravanArrivalActionUtility.GetFloatMenuOptions(() => CanVisit(caravan, escapeShip), () => new CaravanArrivalAction_VisitEscapeShip(escapeShip.GetComponent<VoidEscapeShipComp>()), "VisitEscapeShip".Translate(escapeShip.Label), caravan, escapeShip.Tile, escapeShip);
		}
	}
}